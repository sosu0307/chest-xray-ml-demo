...
MODEL_PATH = Path("/kaggle/working/models/resnet101_best.pt")

MODEL_NAME = "resnet101"

IMG_SIZE = 224
BATCH_SIZE = 8  # Lower batch size for ResNet-101 memory management
ALPHA = 0.15

# =========================
# 2) Dataset Class (Self-contained to fix 'not defined' error)
# =========================
...
def main():
    ...
    # Initialize ResNet-101 Architecture
